...
spark = (SparkSession.builder.appName("RaisProcessor")
    .config("spark.jar.packages", "io.delta:delta-core_2.12:1.0.0")
...
rais = (
    spark.read
    .csv("s3://desafio-mod-1/raw_zone", inferSchema=True, header=True, sep=';', encoding="latin1")
)
...
(
    ...
    .partitionBy('ano', 'uf')
    .format('parquet')
    .save('s3://desafio-mod-1/refined_zone')
)
